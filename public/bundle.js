...
var app = (function () {
    ...
    /* src/UI/Header.svelte generated by Svelte v3.17.3 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1ure8zb");
    			add_location(h1, file, 23, 4, 419);
    			attr_dev(header, "class", "svelte-1ure8zb");
    			add_location(header, file, 22, 0, 406);
    		},
    ...
    /* src/UI/Button.svelte generated by Svelte v3.17.3 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-1mbmz8y");
    			add_location(button, file$1, 84, 0, 1376);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-1mbmz8y");
    			add_location(a, file$1, 82, 4, 1340);
    		},
    		m: function mount(target, anchor) {
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment$1, safe_not_equal, { type: 0, caption: 1, href: 2 });
    ...
    /* src/Meetups/MeetupItem.svelte generated by Svelte v3.17.3 */
    ...
    /* src/Meetups/MeetupGrid.svelte generated by Svelte v3.17.3 */
    ...
    /* src/UI/TextInput.svelte generated by Svelte v3.17.3 */
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 45, 8, 958);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$4, 43, 4, 873);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(43:0) {#if controlType === 'textarea'}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$4, 41, 4, 802);
    			attr_dev(div, "class", "form-control svelte-19icdtr");
    			add_location(div, file$4, 40, 0, 771);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-9umujb");
    			add_location(form, file$5, 57, 4, 1597);
    			attr_dev(main, "id", "meetups");
    			attr_dev(main, "class", "svelte-9umujb");
    			add_location(main, file$5, 56, 0, 1573);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	let meetups = [
    		{
    			...
    			description: "In this meetup, we will have etc...",
    			imageURL: "https://via.placeholder.com/800x600",
    			address: "placeholder street, placeholder city",
